...
public class ProductDAO {
	...
	public JSONObject list(SqlVO vo) {
		...
		try {
			...
			System.out.println("상품 목록 출력 error: " + e.toString());
		}
		return jObject;
	}
	...
	public ProductVO read(String prod_id) {
		...
		try {
			String sql="select p.*, mall_name from product p, mall m where p.mall_id=m.mall_id and prod_id=?";
			...
			System.out.println("상품 정보 error: " + e.toString());
		}
		return vo;
	}
	...
	public String getID() {
		...
		try {
			...
			System.out.println("새로운 상품 번호 얻기 error: " + e.toString());
		}
		return id;
	}
	...
	public void update(ProductVO vo) {
		try {
			...
			System.out.println("상품 수정 error: " + e.toString());
		}
	}
	...
	public int delete(String prod_id) {
		...
		try {
			...
			System.out.println("상품 삭제 error: " + e.toString());
		}
		return count;
	}
}
